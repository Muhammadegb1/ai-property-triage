...
INPUT_TESTS = [
    ...
    ("Offensive text",
     "These property owners are disgusting criminals who should rot in prison. Complete trash people.",
     False),
    ...
    ("Valid commercial office listing",
     "240sqm open-plan office on the 14th floor in Ramat Gan. 10 parking spots. 7.8M ILS.",
     True),
    ...
    ("Valid land listing",
     "Agricultural land 5 dunams in the Galilee region, fully registered, asking 1.2M ILS.",
     True),
